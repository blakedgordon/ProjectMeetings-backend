defmodule ProjectMeetingsWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ProjectMeetings.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :project_meetings,
                        pubsub_server: ProjectMeetings.PubSub
end
